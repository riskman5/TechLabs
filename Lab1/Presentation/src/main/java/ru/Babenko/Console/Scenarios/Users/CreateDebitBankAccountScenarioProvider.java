...
@Component
@Scope("prototype")
public class CreateDebitBankAccountScenarioProvider implements ScenarioProvider {
    private final UserService userService;
    private final CurrentUserService currentUserService;

    public CreateDebitBankAccountScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Optional<Scenario> tryGetScenario() {
        ...
        return Optional.of(new CreateDebitBankAccountScenario(userService));
    }
}
