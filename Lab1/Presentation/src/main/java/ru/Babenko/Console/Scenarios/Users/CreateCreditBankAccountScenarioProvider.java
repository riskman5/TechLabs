...
@Component
@Scope("prototype")
public class CreateCreditBankAccountScenarioProvider implements ScenarioProvider {
    private final UserService userService;
    private final CurrentUserService currentUserService;

    public CreateCreditBankAccountScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Optional<Scenario> tryGetScenario() {
        ...
        return Optional.of(new CreateCreditBankAccountScenario(userService));
    }
}
