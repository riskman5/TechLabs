...
@Component
@Scope("prototype")
public class CreateDepositBankAccountScenarioProvider implements ScenarioProvider {
    private final UserService userService;
    private final CurrentUserService currentUserService;

    public CreateDepositBankAccountScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Optional<Scenario> tryGetScenario() {
        ...
        return Optional.of(new CreateDepositBankAccountScenario(userService));
    }
}
