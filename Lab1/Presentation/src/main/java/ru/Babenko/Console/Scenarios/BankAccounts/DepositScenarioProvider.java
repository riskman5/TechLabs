...
@Component
@Scope("prototype")
public class DepositScenarioProvider implements ScenarioProvider {
    private final BankAccountService bankAccountService;
    private final CurrentBankAccountService currentBankAccountService;

    public DepositScenarioProvider(BankAccountService bankAccountService, CurrentBankAccountService currentBankAccountService) {
    ...
    public Optional<Scenario> tryGetScenario() {
        ...
        return Optional.of(new DepositScenario(bankAccountService));
    }
}
