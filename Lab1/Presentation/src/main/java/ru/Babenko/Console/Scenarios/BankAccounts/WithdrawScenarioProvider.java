...
@Component
@Scope("prototype")
public class WithdrawScenarioProvider implements ScenarioProvider {
    private final BankAccountService bankAccountService;
    private final CurrentBankAccountService currentBankAccountService;

    public WithdrawScenarioProvider(BankAccountService bankAccountService, CurrentBankAccountService currentBankAccountService) {
    ...
    public Optional<Scenario> tryGetScenario() {
        ...
        return Optional.of(new WithdrawScenario(bankAccountService));
    }
}
